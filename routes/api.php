...
Route::middleware(['jwt', 'check.jwt.tenant'])->group(function () {
    ...
    Route::get('produtos-mini2', [ProdutoController::class, 'indexMini2']);
    ...
    Route::get('relatorios/vendas-ao-longo-do-tempo', [RelatorioController::class, 'vendasAoLongoDoTempo']);
    ...
    Route::get('relatorios/analise-despesas', [RelatorioController::class, 'analiseDespesas']);
});
